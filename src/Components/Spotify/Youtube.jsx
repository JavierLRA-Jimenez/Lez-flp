...
const Youtube = () => {
  return (
    <motion.div className=' md:h-[50rem] bg-cover bg-center bg-fixed' style={{ backgroundImage: `url(${bluelightlez})` }} id='youtube'>
      ...
      <div className="flex flex-col md:flex-row md:mt-10 items-center relative z-10 md:pl-10 lg:justify-center">
      ...
      <div className='flex flex-col md:flex-row items-center justify-center md:pt-10 lg:hidden'>
